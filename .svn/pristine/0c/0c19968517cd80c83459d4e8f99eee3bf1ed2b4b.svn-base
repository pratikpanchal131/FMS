...
#define FMS_LoginPushText  @"is_text_enabled"
#define FMS_LoginPushEmail  @"is_push_enabled"

#define FMS_LoginProfileStatus @"FMS_LoginProfileStatus"
...
#define FMS_arrGetTrailerData @"FMS_arrayGetTrailerData"
...
//Stagging
#define FMS_WSURL @"http://php54.indianic.com/fleetmgtsystem/api/v3"
