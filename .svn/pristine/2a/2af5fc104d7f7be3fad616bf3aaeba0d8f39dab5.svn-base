...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	[[self shared] hudMake:status image:nil spin:YES hide:NO withBOOL:NO];
}
...
{
	[self shared].interaction = YES;
	[[self shared] hudMake:status image:HUD_IMAGE_SUCCESS spin:NO hide:YES withBOOL:YES];
}
...
{
	[self shared].interaction = YES;
	[[self shared] hudMake:status image:HUD_IMAGE_ERROR spin:NO hide:YES withBOOL:NO];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)hudMake:(NSString *)status image:(UIImage *)img spin:(BOOL)spin hide:(BOOL)hide withBOOL:(BOOL)success
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[self hudCreate];
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (hud == nil)
	{
        ...
        UIImageView *aimageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 80, 80)];
        aimageView.backgroundColor = [UIColor blackColor];
        aimageView.alpha = 0.8;
        aimageView.image = [UIImage imageNamed:@"Top_NavBarBG"];
        aimageView.autoresizingMask = UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleWidth;
        [hud insertSubview:aimageView atIndex:0];
	...
	if (image == nil)
	{
		image = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 22, 22)];
	}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	CGFloat hudWidth = 60, hudHeight = 60;
//	//---------------------------------------------------------------------------------------------------------------------------------------------
//	if (label.text != nil)
//	{
...
//
//		labelRect.origin.x = 14;
//		labelRect.origin.y = 46;
//
//		hudWidth = labelRect.size.width + 24;
//		hudHeight = labelRect.size.height + 60;
//
//		if (hudWidth < 60)
//		{
//			hudWidth = 60;
...
//	}
    ...
    spinner.center =CGPointMake(hud.frame.size.width/2, hud.frame.size.height/2);
...
//	}
    ...
    spinner.center =CGPointMake(hud.frame.size.width/2, hud.frame.size.height/2);
    image.center =CGPointMake(imagex, imagey-10);
